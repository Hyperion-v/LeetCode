...
public class TomcatThreadPoolExecutor extends java.util.concurrent.ThreadPoolExecutor {
    /**
    ...
    public TomcatThreadPoolExecutor(int corePoolSize, int maximumPoolSize, long keepAliveTime, TimeUnit unit, BlockingQueue<Runnable> workQueue, ThreadFactory threadFactory) {
        super(corePoolSize, maximumPoolSize, keepAliveTime, unit, workQueue, threadFactory, new TomcatThreadPoolExecutor.RejectHandler());
        prestartAllCoreThreads();
    }
    ...
    public TomcatThreadPoolExecutor(int corePoolSize, int maximumPoolSize, long keepAliveTime, TimeUnit unit, BlockingQueue<Runnable> workQueue) {
        super(corePoolSize, maximumPoolSize, keepAliveTime, unit, workQueue, new TomcatThreadPoolExecutor.RejectHandler());
        prestartAllCoreThreads();
    }
